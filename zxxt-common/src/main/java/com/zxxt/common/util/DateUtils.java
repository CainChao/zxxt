...
import com.zxxt.common.exception.BusinessException;
...
public class DateUtils {
	 ...
	 * 时间格式化对象（yyMM）
	 */
	public static final SimpleDateFormat DATE_FORMAT8 = new SimpleDateFormat("yyyyMM");

	/**
	 * 时间格式化对象（yyMM）
	 */
	public static final SimpleDateFormat DATE_FORMAT9 = new SimpleDateFormat("yyyy-MM-dd HH:mm");

	/**
	 * 时间格式化对象（yyyy年MM月dd）
	 */
	public static final SimpleDateFormat DATE_FORMAT10 = new SimpleDateFormat("yyyy 年 MM 月 dd");
	...
	public static List<Integer> getYearMonthList(Date beginMonth, Date endMonth) {
		...
		while (min.compareTo(max) <= 0) {
			Integer format = Integer.valueOf(DateUtils.DATE_FORMAT_YYYYMM.format(min.getTime()));
			result.add(format);
